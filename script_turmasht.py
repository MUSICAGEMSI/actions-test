...
# URL CORRIGIDA - mesmo endpoint do script de aulas
...
def extrair_dados_turma(session, turma_id):
    ...
    try:
        ...
        # Extrair HORA DE INÍCIO (formato HH:MM)
        ...
        # Extrair HORA DE FIM (formato HH:MM)
...
def obter_matriculados(session, turma_id):
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            # Contar linhas válidas no tbody
    ...
    for turma_id in ids:
        ...
        with lock:
            ...
            if dados:
                ...
                if progresso['validos'] % 50 == 0:
                    print(f"[{progresso['processados']}/{RANGE_FIM}] Turmas: {progresso['validos']} | "
