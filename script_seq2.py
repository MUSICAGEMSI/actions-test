...
def carregar_instrutores_hortolandia(session, max_tentativas=5):
    """Carrega lista completa de instrutores de Hortolândia (RETORNA IDs E NOMES NORMALIZADOS)"""
    ...
    for tentativa in range(1, max_tentativas + 1):
        try:
            ...
            print(f"\n📋 Amostra (primeiros 5):")
            for i, (id_inst, nome) in enumerate(list(ids_dict.items())[:5], 1):
    ...
    try:
        ...
        if resposta_post.status_code == 200:
            ...
            if body_content.get('status') == 'sucesso':
                ...
                print(f"\n✅ PLANILHA DE AULAS CRIADA COM SUCESSO!")
