...
def main():
    ...
    # Data/hora de início: 10/10/2025 00:00:00
    ...
    # Busca 1: Primeiro ID com abertura >= 10/10/2025 00:00
    ...
    # ========================================================================
    # 🆕 ENVIO: Nova planilha será criada automaticamente
    # ========================================================================
    
    # 🆕 Nome da planilha será gerado automaticamente pelo Apps Script
    nome_planilha = timestamp_execucao.strftime("Aulas_%d_%m_%y-%H:%M")
    
    body = {
        "tipo": "historico_aulas_hortolandia",  # 🆕 Tipo para criar nova planilha
        "dados": resultado,
        "headers": [
    ...
    print(f"Nova planilha será criada: {nome_planilha}")
    print("=" * 70)
    ...
    print(f"📄 Nova planilha: {nome_planilha}")
