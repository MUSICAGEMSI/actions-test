...
def executar_historico(cookies_dict, alunos_modulo2):
    """Executa coleta de histórico individual com sistema de 3 fases + envio em lotes"""
    tempo_inicio = time.time()
...
def main():
    ...
    print("\n" + "=" * 80)
    print("🎼 SISTEMA MUSICAL - COLETOR COMPLETO V3.0")
    print("=" * 80)
    print("📋 Ordem de execução:")
    print("   1️⃣ Login Único")
    print("   2️⃣ Localidades de Hortolândia (cria planilha)")
    print("   3️⃣ Coleta de Alunos (cria planilha)")
    print("   4️⃣ Histórico Individual (cria planilha em lotes)")
    print("=" * 80)
